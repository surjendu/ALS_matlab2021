function ungated_momenta(px1,px2,px3,py1,py2,py3,pz1,pz2,pz3,binsize_px,binsize_py,binsize_pz,binsize_p,p1,p2,p3,...
...
edges_p=[-edge_max:binsize_p:edge_max];
...
[p3_counts,p3_edges]=histcounts(p3,edges_p);
...
grid on;
xlim([px_plot_rng(1) px_plot_rng(2)]);
...
set(gca, 'XScale', 'linear','YScale', 'linear','FontSize',30,'GridColor', [0.1, 0.7, 0.2],'GridAlpha',0.95,'LineWidth',1 );
grid on;
xlim([px_sum_plot_rng(1) px_sum_plot_rng(2)]);
...
set(gca, 'XScale', 'linear','YScale', 'linear','FontSize',30,'GridColor', [0.1, 0.7, 0.2],'GridAlpha',0.95,'LineWidth',1 );
grid on;
xlim([py_plot_rng(1) py_plot_rng(2)]);
...
set(gca, 'XScale', 'linear','YScale', 'linear','FontSize',30,'GridColor', [0.1, 0.7, 0.2],'GridAlpha',0.95,'LineWidth',1 );
grid on;
xlim([py_sum_plot_rng(1) py_sum_plot_rng(2)]);
...
set(gca, 'XScale', 'linear','YScale', 'linear','FontSize',30,'GridColor', [0.1, 0.7, 0.2],'GridAlpha',0.95,'LineWidth',1 );
grid on;
xlim([pz_plot_rng(1) pz_plot_rng(2)]);
...
set(gca, 'XScale', 'linear','YScale', 'linear','FontSize',30,'GridColor', [0.1, 0.7, 0.2],'GridAlpha',0.95,'LineWidth',1 );
grid on;
xlim([pz_sum_plot_rng(1) pz_sum_plot_rng(2)]);
