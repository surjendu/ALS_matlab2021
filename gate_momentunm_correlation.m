function [j_momentum_square_gate,px1,py1,pz1,px2,py2,pz2,px3,py3,pz3,p1,p2,p3]...
...
j_momentum_square_gate =   px1-px2-px3 > px1_px2_px3_dif_rng(1) &  px1-px2-px3 < px1_px2_px3_dif_rng(2)...
                         & py1-py2-py3 > py1_py2_py3_dif_rng(1) &  py1-py2-py3 < py1_py2_py3_dif_rng(2)...
                         & pz1-pz2-pz3 > pz1_pz2_pz3_dif_rng(1) &  pz1-pz2-pz3 < pz1_pz2_pz3_dif_rng(2)...
                         & px1+px2+px3 > px1_px2_px3_sum_rng(1) &  px1+px2+px3 < px1_px2_px3_sum_rng(2)...
                         & py1+py2+py3 > py1_py2_py3_sum_rng(1) &  py1+py2+py3 < py1_py2_py3_sum_rng(2)...
                         & pz1+pz2+pz3 > pz1_pz2_pz3_sum_rng(1) &  pz1+pz2+pz3 < pz1_pz2_pz3_sum_rng(2);
            
px1 = px1(j_momentum_square_gate);
py1 = py1(j_momentum_square_gate);
pz1 = pz1(j_momentum_square_gate);
p1  = p1 (j_momentum_square_gate);   


px2 = px2(j_momentum_square_gate);
py2 = py2(j_momentum_square_gate);
pz2 = pz2(j_momentum_square_gate);
p2  = p2 (j_momentum_square_gate);

px3 = px3(j_momentum_square_gate);
py3 = py3(j_momentum_square_gate);
pz3 = pz3(j_momentum_square_gate);
p3  = p3 (j_momentum_square_gate);
